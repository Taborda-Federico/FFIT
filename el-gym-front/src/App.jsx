...
// Importación de la vista principal y Contexto
import { MainPrincipal } from './feactures/gym-main/pantalla_principal/mainPantalla';
import { AuthProvider } from './contex/AuthContext';
import { ProtectedRoute } from './Utils/ProtectedRoute'; // <-- IMPORTAMOS EL GUARDIA (Ajusta la ruta)
...
// Importación de Páginas de User
